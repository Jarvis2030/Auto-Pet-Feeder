...
#define Clock_setting_key_Pin GPIO_PIN_0
#define Clock_setting_key_GPIO_Port GPIOA
#define Clock_setting_key_EXTI_IRQn EXTI0_IRQn
...
#define External_key_Pin GPIO_PIN_5
